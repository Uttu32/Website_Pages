  ...
  return (
    ...
    >
      ...
      <div className="font__secondary text-white text-center sm:text-left">
        <h2 className="text-lg lg:text-xl min-[1100px]:text-2xl xl:text-3xl min-[1368px]:text-[33px] font-medium">
          {title}
        </h2>
        <p className="text-xl lg:text-2xl min-[1100px]:text-3xl xl:text-4xl min-[1368px]:text-[40px] font-bold underline uppercase">
          {subtitle}
        </p>
      </div>
    </div>
