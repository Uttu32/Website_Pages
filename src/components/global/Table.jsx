    ...
    <div className="overflow-hidden">
      <div className="table__background flex items-center  font__secondary text-white">
        <div className="w-[50%] border-r border-r-white text-center py-4">
          <h6 className="text-2xl font-bold"> CHROMODIVERSITY EXAMPLES</h6>
          <p className="text-[23px] font-normal">Unique DNA patterns</p>
        </div>
        <div className="w-[50%] text-center py-4">
          <h6 className="text-2xl font-bold">NEURODIVERSITY EXAMPLES</h6>
          <p className="text-[23px] font-normal">Unique ways brains work</p>
        </div>
      </div>
      {/* 2nd */}
      <div className="border rounded-lg rounded-t-none border-t-0 border-[#6931AA]  flex items-center  font__primary text-black ">
        <div className="w-[50%] px-8 pt-6 pb-2 border-r border-[#6931AA]">
