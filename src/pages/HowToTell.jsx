    ...
    <div>
      ...
      <div className="mx-0 min-[500px]:mx-[20px] md:mx-[70px] rounded-[10px] p-[20px] min-[500px]:p-[35px] sm:p-[50px] md:p-[90px] bg-[#fff4f6db] mb-20">
        ...
        <div className="sm:ml-5 ml-0">
          <ListText
            smallSize
            text=" For example, hormonal therapy may be likened to a friend who requires insulin for diabetes."
          />
          <ListText
            smallSize
      ...
      <div className="mx-0 min-[500px]:mx-[20px] md:mx-[70px] rounded-[10px] p-[20px] min-[500px]:p-[35px] sm:p-[50px] md:p-[90px] bg-[#fff4f6db]">
        ...
        <div className="sm:ml-5 ml-0">
          <ListText
            smallSize
            text="Your child may want to know who else is aware of the diagnosis, when it was made, why this has happened to them, what it means for the future."
          />
          <ListText
            smallSize
      ...
      <div className="mx-0 min-[500px]:mx-[20px] md:mx-[70px] rounded-[10px] p-[20px] min-[500px]:p-[35px] sm:p-[50px] md:p-[90px] bg-[#fff4f6db] mb-20">
        ...
        <div className="sm:ml-5 ml-0">
          <ListText
            smallSize
            text=" Emphasize that sharing the diagnosis is a personal decision to be made by them and their parents."
          />
          <ListText
            smallSize
